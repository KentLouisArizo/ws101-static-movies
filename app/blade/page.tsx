      ...
      <section className="relative h-[80vh] overflow-hidden">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="max-w-4xl px-4 sm:px-6 lg:px-8">
              <h1 className="text-4xl font-bold sm:text-6xl">Blade Runner</h1>
              ...
              <a href="https://ww4.123moviesfree.net/movie/blade-runner-4202/">Watch Now!</a>
            </div>
          </div>
        </section>
        <section className="py-12 px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span>Harrison Ford, Rutger Hauer, Sean Young, Edward James Olmos</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-gray-400">Release Date:</span>
                  <span>June 25, 1982</span>
                </div>
                <div className="flex items-center justify-between">
            ...
            <div>
              ...
              Deckard (Harrison Ford) is forced by the police Boss (M. Emmet Walsh) 
              to continue his old job as Replicant Hunter. His assignment: eliminate 
              four escaped Replicants from the colonies who have returned to Earth. 
              Before starting the job, Deckard goes to the Tyrell Corporation and he 
              meets Rachel (Sean Young), a Replicant girl he falls in love with.
              </p>
            </div>
          </div>
        </section>
